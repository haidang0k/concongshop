    ...
    <head>
        ...
        <script>
            ...
            window.onload = function () {
                ...
                var jsonString = document.getElementById("products").value;
                ...
                for (var i = 0; i < products.length; i++) {
                    table.row.add([
                        ...
                        products[i].price,
                        products[i].status === 1 ? 'active' : 'inactive',
                        '<a href="load?pid=' + products[i].id + '"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>'
                    ]).draw();
                }
            };
        </script>
    ...
    <body>
        ...
        <div class="container">
            <div class="table-wrapper">
                ...
                <input  type="hidden" id="products" value='${requestScope.products}'/>
                <table id="myTable">
                    <thead>
                        <tr>
                            <th>ID</th>
