    ...
    <head>
        ...
        <script>
            ...
            window.onload = function () {
                ...
                var jsonString = document.getElementById("orders").value;
                var orders = JSON.parse(jsonString);
                for (var i = 0; i < orders.length; i++) {
                    const status = orders[i].status;
                    const statusColor =
                            status == 0 ? "color: orange" : status == 1 ? "color: blue" : "color: green";
                    const statusText =
                            status == 0 ? "pending" : status == 1 ? "processing" : "done";
                    const spanElementString =
                    ...
                    table.row.add([
                        ...
                        spanElementString,
                        '<a href="editOrder?pid=' + orders[i].id + '"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>'
                    ]).draw();
                }
            };
        </script>
    ...
    <body>
        ...
        <div class="container">
            <div class="table-wrapper">
                ...
                <input  type="hidden" id="orders" value='${requestScope.orders}'/>
                <table id="myTable">
                    <thead>
                        <tr>
                            <th>ID</th>
